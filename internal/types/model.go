...
// cartridge. On CGB/AGB hardware this is the compatibility-mode state verified
// by Mooneye's boot_regs-cgb and boot_regs-A tests.
...
// ModelRegistersCGB contains the post-boot state for cartridges that request
// CGB mode. whichboot.gb sets the CGB-compatible header flag, so its CGB/AGB
// fingerprints differ from Mooneye's DMG-only boot register tests.
